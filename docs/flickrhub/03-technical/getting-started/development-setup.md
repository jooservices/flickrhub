...
3. Update `docs/flickrhub/03-technical/api/README.md`
...
1. Create backlog item in `docs/flickrhub/06-product/backlog/active/`
2. Implement feature
3. Add tests
4. Update documentation
...
- **[Backlog](../06-product/backlog/README.md)** - Current work items
