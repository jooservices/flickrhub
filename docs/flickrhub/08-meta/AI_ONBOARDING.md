...
│
├── docs/                    # Documentation
│   ├── master/             # Architecture Center (submodule; leave untouched)
│   └── flickrhub/          # Project docs
│       ├── 00-index/       # Docs index
│       ├── 01-governance/  # Reviews/governance
│       ├── 02-architecture/# Architecture docs
│       ├── 03-technical/   # Technical docs (API, getting started)
│       ├── 04-data/        # Data/reference docs
│       ├── 05-systems/     # Infrastructure docs
│       ├── 06-product/     # Backlog management
│       ├── 07-guides/      # How-to guides & runbooks
│       ├── 08-meta/        # Meta docs (this file, structure guide)
│       ├── 09-archived/    # Incidents & investigations
...
See `../06-product/backlog/active/p0-critical.md` for details:
...
See `../06-product/backlog/active/` for complete list.
...
- **API Docs**: `../03-technical/api/README.md`
- **Operations**: `../07-guides/operations.md`
- **Backlog**: `../06-product/backlog/README.md`
- **Infrastructure**: `../05-systems/infrastructure/README.md`
- **Architecture Review**: `../01-governance/reviews/ARCHITECTURE_REVIEW.md`
...
See `../06-product/backlog/active/` for detailed items.
...
1. Update `../03-technical/api/README.md`
...
2. Update `../05-systems/infrastructure/`
...
1. **Read Context First**
   ...
   - Check `../06-product/backlog/active/` for current priorities
...
- [Architecture Review](../01-governance/reviews/ARCHITECTURE_REVIEW.md) - Detailed SA assessment
- [Backlog Guide](../06-product/backlog/README.md) - How to manage backlog
- [Operations Guide](../07-guides/operations.md) - Operational runbook
